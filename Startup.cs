    ...
    public class Startup
{
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddControllersWithViews();
            ...
            String connectionString = "Server=tcp:sp22vuvictoriahw3.database.windows.net,1433;Initial Catalog=sp22vuvictoriahw3;Persist Security Info=False;User ID=sp22vuvictoriahw3;Password=Victoria777;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
